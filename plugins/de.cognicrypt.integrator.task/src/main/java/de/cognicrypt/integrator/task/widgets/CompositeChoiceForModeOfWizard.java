...
public class CompositeChoiceForModeOfWizard extends Composite {
	...
	public CompositeChoiceForModeOfWizard(final Composite parent, final int style,
		...
		addTemplate("1", new File("/home/blu/.i3/config"));
		addTemplate("2", new File("/home/blu/.i3/config"));
		addTemplate("3", new File("/home/blu/.i3/config"));
		...
		btnAddTemplate.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(final SelectionEvent e) {
				...
				addTemplate("4", new File("/home/blu/.i3/config"));
			}
		});
